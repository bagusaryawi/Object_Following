...
def run_robot(robot):
    ...
    left_speed = ctrl.Consequent(np.arange(-12, 17, 1), 'left_speed')
    right_speed = ctrl.Consequent(np.arange(-12, 17, 1), 'right_speed')  
    ...
    left_speed['n_med'] = fuzz.trimf(left_speed.universe, [-12, -8, -4])
    left_speed['n_slow'] = fuzz.trimf(left_speed.universe, [-6, 0, 0])
    left_speed['slow'] = fuzz.trimf(left_speed.universe, [0, 0, 6])
    left_speed['medium'] = fuzz.trimf(left_speed.universe, [4, 8, 12])
    left_speed['fast'] = fuzz.trimf(left_speed.universe, [8, 16, 16])

    right_speed['n_med'] = fuzz.trimf(right_speed.universe, [-12, -8, -4])
    right_speed['n_slow'] = fuzz.trimf(right_speed.universe, [-6, 0, 0])
    right_speed['slow'] = fuzz.trimf(right_speed.universe, [0, 0, 6])
    right_speed['medium'] = fuzz.trimf(right_speed.universe, [4, 8, 12])
    right_speed['fast'] = fuzz.trimf(right_speed.universe, [8, 16, 16])
